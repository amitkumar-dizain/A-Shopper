<div class="container-fluid">
	<div class="row">
		<div class="col-xl-12">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page"><a
					href="${contextRoot}/all/products">All products</a></li>
	...
	<%-- <div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			...
			<c:choose>
				<c:when test="${product.quantity<1}">
					<a href="javascript:void(0)" class="btn btn-warning disabled"><strike>Add
							to Cart</strike></a>
				</c:when>
				<c:otherwise>
			...
			<a href="${contextRoot}/all/products" class="btn btn-primary">Continue
				Shopping</a>
				...
				<div class="d-flex align-items-center mb-4 pt-2">
					<div class="input-group quantity mr-3" style="width: 130px;">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<input type="text" class="form-control bg-secondary border-0 text-center" value="${product.quantity}">
							</c:otherwise>
						</c:choose>
						<div class="input-group-btn">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<a href="${contextRoot}/add/cart/${product.id}/product"
								class="btn btn-primary"><i class="fa fa-shopping-cart mr-1"></i>
								Add To Cart</a>
						</c:otherwise>
					</c:choose>
				</div>
